...
// var jsProp = { id: dashboardId, dashId: dashId, roleId, tags: jsFields.tags, userId: { type: 'string' }, meta, notifications: { type: 'array' }, role: { type: 'object' } }
var jsProp = { id: dashboardId, name: { type: 'string' }, userId, subscription: { type: 'object' }, dashId, public: { type: 'boolean' }, body: { type: 'string' }, location, tags: jsFields.tags, toTags: { type: 'array', items: { type: 'string' } }, toRoles: { type: 'array', items: { type: 'string' } }, pics, meta, user: { type: 'object' }, readedByUser: { type: 'boolean' }, notifications: { type: 'array' } }
