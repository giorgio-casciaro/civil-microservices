...
const mutate = (id, mutation, meta, data) => mutationsPack.mutate({data, objId: id, mutation, meta})
const saveMutationsAndUpdateView = async function (id, mutations, view) {
  // try {
...
var serviceAutotest = async function (reqData, meta, getStream) {
  ...
  try {
    ...
    await DB.put('view', {id: testId, email, test: true})
...
var serviceMethods = {
  ...
  rawMutate: {
    ...
    exec: async function (reqData, meta = {directCall: true}, getStream = null) {
      ...
      var view = await saveMutationsAndUpdateView(reqData.id, [mutation])
  ...
  confirmEmail: {
    ...
    exec: async function (reqData, meta = {directCall: true}, getStream = null) {
      ...
      var view = await saveMutationsAndUpdateView(id, [mutation], currentState)
  ...
  addPic: {
    ...
    exec: async function (reqData, meta = {directCall: true}, getStream = null) {
      ...
      await DB.put('picMeta', {id: picId, userId: id, sizes: picData.sizes}, picId + '_meta')
