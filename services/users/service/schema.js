...
module.exports = {
  ...
  methods: {
    ...
    'create': {
      public: true,
      responseType: 'response',
      requestSchema: { properties: jsProp, required: [ 'email' ] },
      responseSchema: jsRes
    },
    'rawMutate': {
      public: true,
      responseType: 'response',
      requestSchema: { properties: {data: jsProp, mutation: { type: 'string' }}, required: [ 'mutation', 'data' ] },
      responseSchema: jsRes
    },
    'update': {
      public: true,
      responseType: 'response',
      requestSchema: { properties: jsProp, required: [ 'id' ] },
      responseSchema: jsRes
    },
    'read': {
      public: true,
