...
export default {
  ...
  created(){
    this.$store.dispatch("dashboards/rpcQueryLoadMore",{api:"list", data})
    // call('dashboards', 'listList', {from: 0, to: pageLength}, (payload) => store.commit('DASHBOARDS_LIST', payload))
  },
  components: {  },
  computed: {
    strList: function () { return t('Ultime Bacheche') },
